	...
	<div class="container">
		<div class="col-md-8 col-md-offset-2">
			...
			<?php
				...
				//$_SESSION["quantitiy"]=$_POST["quantity"];
			?>
			<form action="bill.php" method="post">
				...
				for(;$j<$i;$j++)
				{
					/* if($idpro == null)
					{
						print("Please return to the Shoping Section and choose product")
						break;
					} */
							...
							<div class="col-md-3 product-grids">
								<div class="agile-products">
									...
									<div class="agile-product-text">
										...
										<?php print "<h6>Product ID: ".$row[0]."</h6>";?>
										<?php print "<h6>Price: ".$row[2]."</h6>";?>
				...
				<div class="col-md-offset-3">
					<?php
						if($b1 == 0)
						{
							...
							<?php print "Please cancel the order and return to the Shoping Section to choose your product"?>
							<?php
						...
						{
							?>
							<button type="submit" class="btn btn-primary col-md-4">Confirm order</button>
							<?php
						}
		...
		<footer class="color1" style="color:#FEBD69; margin-top:10%;">
			<h2 style="text-align:center; padding-top:2%; font-family:serif; font-weight:bold;">Thỏa đam mê, Phê khách hàng</h2>
