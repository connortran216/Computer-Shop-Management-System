...
if (isset($_POST['add']))
{
	...
	/* try {
		move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], "images" . DS .$PID. DS . "1.jpg ");
	} catch (Exception $ex) {
		var_dump($ex);
		die();
	} */
...
<html>
	...
	<body>
		...
		<div "col-md-4 col-md-offset-0">
			...
			<span style="font-style:italic; font-size:20px"> <a href="update.php" class="col-md-12 col-md-offset-3" style="text-decoration:none; color:red;font-weight:bold;">Want to update a product</a></span>
			<span style="font-style:italic; font-size:20px"> <a href="delete.php" class="col-md-12 col-md-offset-3" style="text-decoration:none; color:red;font-weight:bold;">Want to delete a product</a></span>
